...
import { RunningIndicator } from "@/components/devsummary/agents/running-indicator";
...
export type ThreadComponents = {
  ...
  /** Starter prompts under the composer on an empty new chat. */
...
const ThreadRoot: FC<{ isEmpty: boolean }> = ({ isEmpty }) => {
  const { Welcome = ThreadWelcome, Suggestions = ThreadSuggestions } =
...
const MessageError: FC = () => {
  return (
    <MessagePrimitive.Error>
      <ErrorPrimitive.Root className="aui-message-error-root border-destructive bg-destructive/10 text-destructive dark:bg-destructive/5 mt-2 rounded-md border p-3 text-sm dark:text-destructive-foreground">
